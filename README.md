...
코로나 당시 밖을 못 나가니 실내에서 핸드폰으로 할 수 있는 것들이 유행하였습니다.


그 중 심리 테스트들이 유행을 하였는데, 여러 테스트 중 MBTI(성격 유형) 검사가 인기를 끌게 되었습니다.


시간이 지나 사회적 거리두기가 끝나게 되었고, 여행을 가는 사람이 많아지게 됩니다.


이전에 유행했던 MBTI를 통해 비슷한 성향을 가진 사람들의 여행지를 참고하여 계획하게 된다면, 


더욱 만족도 높은 여행을 기대할 수 있겠다는 생각에 제작을 결심하게 됐습니다.
